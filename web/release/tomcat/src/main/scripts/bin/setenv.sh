...
# Jeyzer variables
JEYZER_WEB_ANALYZER_WORK_DIR="/data/jeyzer/analyzer/work/web/analysis"
export JEYZER_WEB_ANALYZER_WORK_DIR

# Factory directories
JEYZER_ANALYZER_CONFIG_DIR="/data/jeyzer/analyzer/config"
export JEYZER_ANALYZER_CONFIG_DIR

# Profile directories
JEYZER_EXTERNAL_MASTER_PROFILES_DIR="/data/jeyzer/profiles/external/master"
export JEYZER_EXTERNAL_MASTER_PROFILES_DIR
JEYZER_EXTERNAL_SHARED_PROFILES_DIR="/data/jeyzer/profiles/external/shared"
export JEYZER_EXTERNAL_SHARED_PROFILES_DIR

JEYZER_BASE_MASTER_PROFILES_DIR="/data/jeyzer/profiles/base/master"
export JEYZER_BASE_MASTER_PROFILES_DIR
JEYZER_BASE_SHARED_PROFILES_DIR="/data/jeyzer/profiles/base/shared"
export JEYZER_BASE_SHARED_PROFILES_DIR
JEYZER_BASE_HELPER_PROFILES_DIR="/data/jeyzer/profiles/base/helper"
export JEYZER_BASE_HELPER_PROFILES_DIR

JEYZER_DEMO_MASTER_PROFILES_DIR="/data/jeyzer/profiles/demo/master"
export JEYZER_DEMO_MASTER_PROFILES_DIR
JEYZER_DEMO_SHARED_PROFILES_DIR="/data/jeyzer/profiles/demo/shared"
...
JEYZER_EXTERNAL_REPOSITORY_SETUP_DIRECTORY="/data/jeyzer/profiles/shared-repositories"
export JEYZER_EXTERNAL_REPOSITORY_SETUP_DIRECTORY

# Deobfuscation
JEYZER_DEOBSFUCATION_CONFIG_DIR="/data/jeyzer/deobfuscation"
...
# Logging
JEYZER_WEB_ANALYZER_LOG_DIR="/data/jeyzer/work/log"
export JEYZER_WEB_ANALYZER_LOG_DIR

# Java core
JEYZER_WEB_DEBUG=true
export JEYZER_WEB_DEBUG
JAVA_OPTS="$JAVA_OPTS -Xmx2048m -Xms512m -Dlogback.configurationFile=/data/jeyzer/analyzer/config/log/web-analyzer-logback.xml"
export JAVA_OPTS
...
# JEYZER_WEB_TEMP_UPLOAD_DIRECTORY=/tmp/jeyzer/web/upload
