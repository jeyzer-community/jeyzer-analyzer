...
rem Graph refresh period
if not "%JEYZER_GRAPH_REFRESH_PERIOD%" == "" goto gotGraphRefreshPeriod
set JEYZER_GRAPH_REFRESH_PERIOD=4s
:gotGraphRefreshPeriod
...
set JEYZER_ANALYZER_REPLAY_ENABLED=true
...
set PARAMS=-Djeyzer.analysis.config=%JEYZER_TARGET_PROFILES_DIR%\%JEYZER_TARGET_PROFILE%\%JEYZER_TARGET_PROFILE%_analysis.xml -Dlogback.configurationFile=%JEYZER_ANALYZER_CONFIG_DIR%\log\replay-logback.xml
...
echo Starting Jeyzer Replay v${pom.version}...
