...
public class PoolThreadCounterRule extends AbstractNumericDisplayHeaderRule implements Header{

	public static final String RULE_NAME = "pool_thread_counter";
	...
	public PoolThreadCounterRule(ConfigSheetHeader headerCfg, SheetDisplayContext context) {
