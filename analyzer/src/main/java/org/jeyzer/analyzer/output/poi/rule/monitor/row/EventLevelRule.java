...
public class EventLevelRule extends AbstractDisplayRule implements MonitorRowHeader{

	public static final String RULE_NAME = "event_level";
	
	public static final String CELL_LABEL_COMMENT = "Monitoring event level\n Possible values : CRITICAL, WARNING, INFO, ERROR";
	
	private static final String DISPLAY_NAME = "Level";
	
	private boolean hasLink;
	
	public EventLevelRule(ConfigDisplay headerCfg, SheetDisplayContext context){
	...
	public boolean apply(MonitorEvent event, Cell cell) {
		setValue(cell, event.getLevel().toString());
