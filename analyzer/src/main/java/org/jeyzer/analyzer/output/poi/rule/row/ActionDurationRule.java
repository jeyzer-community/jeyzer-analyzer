...
public class ActionDurationRule extends AbstractNumericDisplayRule implements RowHeader{

	public static final String RULE_NAME = "action_duration";
	
	public static final String CELL_LABEL_COMMENT = "Action minimum duration in seconds";
	
	private static final String DISPLAY_NAME = "Duration";
	
	private boolean hasLink;
	
	public ActionDurationRule(ConfigDisplay headerCfg, SheetDisplayContext context){
