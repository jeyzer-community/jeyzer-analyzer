...
public class VarianceFunction extends HeaderFunction {

	public static final String RULE_NAME = "variance";
	...
	public VarianceFunction(HeaderFunction next) {
		super(next);
	}	
	...
	protected void displayValue(Workbook workbook, Cell cell, AbstractNumericDisplayHeaderRule header, CellStyles cellStyles) {
		...
		double variance = FormulaHelper.calculateVariance(values, average);
		
		cell.setCellValue(variance);
		
		applyThreashold(workbook, cell, variance, header, cellStyles);
	}
