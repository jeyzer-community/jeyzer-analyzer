...
public class OpenFileDescriptorCounterRule extends AbstractNumericDisplayHeaderRule implements Header{

	public static final String RULE_NAME = "open_file_descriptor_counter";
	private static final String DISPLAY_NAME = "Open file descriptors";
	public static final String CELL_LABEL_COMMENT = "Number of file descriptors open by the process.\n"
	...
	public OpenFileDescriptorCounterRule(ConfigSheetHeader displayCfg, SheetDisplayContext context) {
