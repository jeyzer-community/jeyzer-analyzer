...
public class OperationPrincipalRule extends AbstractDisplayRule implements RowHeader{
	...
	public OperationPrincipalRule(ConfigDisplay headerCfg, SheetDisplayContext context){
