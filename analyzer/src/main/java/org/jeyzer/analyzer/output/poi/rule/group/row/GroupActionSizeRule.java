...
public class GroupActionSizeRule extends AbstractNumericDisplayRule implements GroupRowHeader{

	public static final String RULE_NAME = "action_size";
	
	public static final String CELL_LABEL_COMMENT = "Number of groups of similar stacks observed consecutively in the recording";
	
	private static final String DISPLAY_NAME = "#Tds";
	
	private boolean hasLink;
	
	public GroupActionSizeRule(ConfigDisplay headerCfg, SheetDisplayContext context){
