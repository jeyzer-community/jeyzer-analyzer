...
public class ApplicativeActivityUsageRule extends AbstractCPUDisplayRule implements DisplayRule {
	
	public static final String RULE_NAME = "act_usage";
	
	public ApplicativeActivityUsageRule(ConfigDisplay displayCfg, SequenceSheetDisplayContext context){
