...
public class ContentionTypeRule extends AbstractCellDisplayRule implements DisplayRule {

	public static final String RULE_NAME = "contention_type";
	
	public ContentionTypeRule (ConfigDisplay displayCfg, SequenceSheetDisplayContext context){
