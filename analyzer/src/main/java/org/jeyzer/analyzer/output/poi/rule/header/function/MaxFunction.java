...
public class MaxFunction extends HeaderFunction {

	public static final String RULE_NAME = "max";
	public static final String DISPLAY_NAME = "Max";

	private Double max = null;
	private Cell targetCell;
	
	public MaxFunction(HeaderFunction next) {
		super(next);
	}
	...
	protected void displayValue(Workbook workbook, Cell cell, AbstractNumericDisplayHeaderRule header, CellStyles cellStyles) {
		...
		cell.setCellValue(this.max);
		
		applyThreashold(workbook, cell, this.max, header, cellStyles);
