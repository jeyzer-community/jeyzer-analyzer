...
public class SysUsageRule extends AbstractCPUDisplayRule implements DisplayRule {
	
	public static final String RULE_NAME = "sys_usage";
	
	public SysUsageRule(ConfigDisplay displayCfg, SequenceSheetDisplayContext context){
