...
public class LockedThreadCounterRule extends AbstractNumericDisplayHeaderRule implements Header{

	public static final String RULE_NAME = "locked_thread_counter";
	private static final String DISPLAY_NAME = "Locked threads";
	public static final String CELL_LABEL_COMMENT = "Locked threads count.\nApplies only to active threads.";
	...
	public LockedThreadCounterRule(ConfigSheetHeader displayCfg, SheetDisplayContext context) {
