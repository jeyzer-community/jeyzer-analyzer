...
public class EventNameRule extends AbstractDisplayRule implements MonitorRowHeader{

	public static final String RULE_NAME = "event_name";
	
	public static final String CELL_LABEL_COMMENT = "Monitoring event name";
	
	private static final String DISPLAY_NAME = "Name";
	
	private boolean hasLink;
	
	public EventNameRule(ConfigDisplay headerCfg, SheetDisplayContext context){
	...
	public boolean apply(MonitorEvent event, Cell cell) {
		...
		setValue(cell, event.getName());
		setColorHighlight(cell, event.getName());
