...
import org.jeyzer.monitor.impl.event.task.advanced.MemoryPercentTaskEvent;

public class MemoryPercentTaskRule extends MonitorTaskRule implements ValueTaskProvider{

	public static final String RULE_NAME = "Memory consuming task";
	
	public static final String RULE_CONDITION_DESCRIPTION = "Task memory usage % which is global heap based is greater or equal to (value).";
	public static final String RULE_NARRATIVE = "The " + RULE_NAME + " rule permits to detect high memory usage at thread level. "
