...
public class ContentionTypeInPrincipalPercentEvent extends MonitorSystemEvent {
	...
	public ContentionTypeInPrincipalPercentEvent(String eventName, MonitorEventInfo info, String principal, String contentionType, Operator operator) {
	...
	protected void dumpExtraParameters(StringBuilder msg) {
		msg.append(this.principal + " / " +  this.contentionType.toUpperCase() + " : " + this.maxValue + "\n");
	}
	
	@Override
	public void addPrintableExtraParameters(List<String> params) {
		params.add(this.principal + " / " +  contentionType.toUpperCase());
