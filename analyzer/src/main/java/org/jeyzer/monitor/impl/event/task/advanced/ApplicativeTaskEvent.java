...
public class ApplicativeTaskEvent extends MonitorTaskEvent implements MonitorApplicativeEvent {
	
	public static final String EVENT_NAME = "Applicative task";
	
	public ApplicativeTaskEvent(MonitorEventInfo info, ThreadAction action, ThreadStackHandler stack) {
