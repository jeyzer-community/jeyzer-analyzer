...
import org.jeyzer.monitor.impl.event.system.ProcessModuleVersionAbsenceEvent;

public class ProcessModuleVersionAbsenceRule extends MonitorSystemRule implements SignalSystemProvider{

	public static final String RULE_NAME = "Process module version absence";
	
	public static final String RULE_NARRATIVE = "The " + RULE_NAME + " rule checks if the Java modules are not versionned."
	...
	public ProcessModuleVersionAbsenceRule(ConfigMonitorRule def) throws JzrInitializationException {
		super(def, RULE_NAME, "Java modules contain no version.");
	}
	...
	public MonitorSystemEvent createSystemEvent(MonitorEventInfo info) {
		return new ProcessModuleVersionAbsenceEvent(this.modules, info);
	}
