...
import org.jeyzer.monitor.impl.event.system.ProcessModuleNameAbsenceEvent;

public class ProcessModuleNameAbsenceRule extends MonitorSystemRule implements PatternSystemProvider{

	public static final String RULE_NAME = "Process module name absence";
	
	public static final String RULE_NARRATIVE = "The " + RULE_NAME + " rule permits to detect the absence of a given Java module."
			+ "It is useful to detect the absence of external recommended modules.";
	
	private String extraInfo;
	
	public ProcessModuleNameAbsenceRule(ConfigMonitorRule def) throws JzrInitializationException {
		super(def, RULE_NAME + " : " + def.getExtraInfo(),
				"Java module name with the (pattern) regex is not found.");
	...
	public MonitorSystemEvent createSystemEvent(MonitorEventInfo info) {
		return new ProcessModuleNameAbsenceEvent(this.extraInfo, info);
	}
