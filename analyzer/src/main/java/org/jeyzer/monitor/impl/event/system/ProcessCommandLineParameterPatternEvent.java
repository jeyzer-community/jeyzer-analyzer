...
public class ProcessCommandLineParameterPatternEvent extends MonitorSystemEvent {

	private Pattern paramNamePattern;
	private String value;
	
	public ProcessCommandLineParameterPatternEvent(String eventName, MonitorEventInfo info, Pattern paramNamePattern) {
