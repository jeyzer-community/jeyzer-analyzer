...
import org.jeyzer.monitor.impl.event.system.ProcessJarVersionSnapshotEvent;

public class ProcessJarVersionSnapshotRule extends MonitorSystemRule implements SignalSystemProvider{

	public static final String RULE_NAME = "Process jar version snapshot";
	
	public static final String RULE_NARRATIVE = "The " + RULE_NAME + " rule checks if the process jars contain non official versions (snapshot, alpha, beta, build..)."
	...
	public ProcessJarVersionSnapshotRule(ConfigMonitorRule def) throws JzrInitializationException {
		super(def, RULE_NAME, "Process jars contain versions with alphabetic tags.");
	}
	...
	public MonitorSystemEvent createSystemEvent(MonitorEventInfo info) {
		return new ProcessJarVersionSnapshotEvent(this.jarVersions, info);
	}
