...
import org.jeyzer.monitor.impl.event.system.ProcessCommandLinePropertyPatternEvent;

public class ProcessCommandLinePropertyPatternRule extends MonitorSystemRule implements PatternSystemProvider{

	public static final String RULE_NAME = "Process command line property pattern";
	
	public static final String RULE_NARRATIVE = "The " + RULE_NAME + " rule permits to check process command line parameter values. "
	...
	public ProcessCommandLinePropertyPatternRule(ConfigMonitorRule def) throws JzrInitializationException {
	...
	public MonitorSystemEvent createSystemEvent(MonitorEventInfo info) {
		return new ProcessCommandLinePropertyPatternEvent(
				this.paramDisplay,
				info,
