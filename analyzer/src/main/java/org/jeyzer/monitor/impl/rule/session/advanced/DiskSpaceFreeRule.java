...
import org.jeyzer.monitor.impl.event.session.advanced.DiskSpaceFreeEvent;

public class DiskSpaceFreeRule extends MonitorSessionRule implements ValueSessionProvider{

	public static final String RULE_NAME = "Disk space free";
	
	public static final String RULE_NARRATIVE = "The " + RULE_NAME + " rule permits to detect lack of disk space under a particular partition or directory, based on the size of free disk space there.";	
	private String diskSpaceName;
	private String displayName;
	
	public DiskSpaceFreeRule(ConfigMonitorRule def)
	...
	public boolean matchValue(ThreadDump dump, long value) {
		...
		if (info == null)
			return false;
		return FormulaHelper.convertToGb(info.getFreeSpace()) <= value;
	}
