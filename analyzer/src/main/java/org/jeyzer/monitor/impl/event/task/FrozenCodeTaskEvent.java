...
public class FrozenCodeTaskEvent extends MonitorTaskEvent {

	private static final String EVENT_NAME = "Frozen code task";
	
	protected long duration;  // in seconds
	
	public FrozenCodeTaskEvent(MonitorEventInfo info, ThreadAction action, ThreadStackHandler stack) {
		super(EVENT_NAME, info, action, stack);
		duration = action.getMinDuration();
	}	
