...
public class StackOverflowEvent extends MonitorTaskEvent {

	public static final String EVENT_NAME = "Stack overflow";		
	
	public StackOverflowEvent(MonitorEventInfo info, ThreadAction action, ThreadStackHandler stack) {
