...
public class RestartProcessEvent extends MonitorSessionEvent {

	public static final String EVENT_NAME = "Process restart";
	
	private Date restartDate = null;
	
	public RestartProcessEvent(MonitorEventInfo info, ThreadDump dump) {
