...
import org.jeyzer.monitor.impl.event.session.ActiveThreadLimitEvent;

public class ActiveThreadLimitRule extends MonitorSessionRule implements ValueSessionProvider{

	public static final String RULE_NAME = "Active thread limit";
	
	public static final String RULE_CONDITION_DESCRIPTION = "Number of active threads is greater or equal to (value).";
	public static final String RULE_NARRATIVE = "The " + RULE_NAME + " rule permits to detect a high number of active threads and therefore peak of process activities.";
	
	public ActiveThreadLimitRule(ConfigMonitorRule def)
	...
	public MonitorSessionEvent createSessionEvent(MonitorEventInfo info, ThreadDump td){
		return new ActiveThreadLimitEvent(info,	td);
	}
	...
	public boolean matchValue(ThreadDump dump, long value) {
		return dump.getWorkingThreads().size() >= value;
	}
