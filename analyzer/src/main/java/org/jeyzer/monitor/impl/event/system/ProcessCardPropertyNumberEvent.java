...
public class ProcessCardPropertyNumberEvent extends MonitorSystemEvent {

	private Pattern paramNamePattern;
	private long maxValue;
	private Operator operator;
	
	public ProcessCardPropertyNumberEvent(String eventName, MonitorEventInfo info, Pattern paramNamePattern, Operator operator) {
