...
import org.jeyzer.monitor.impl.event.system.OperationGlobalPercentEvent;
import org.jeyzer.monitor.util.Operator;

import com.google.common.collect.Multiset;

public class OperationGlobalPercentRule extends MonitorSystemRule implements ValueSystemProvider{

	public static final String RULE_NAME = "Operation global percentage";
	...
	public OperationGlobalPercentRule(ConfigMonitorRule def) throws JzrInitializationException {
	...
	public MonitorSystemEvent createSystemEvent(MonitorEventInfo info) {
		return new OperationGlobalPercentEvent(
				this.paramDisplay,
				info,
				this.operation,
				this.operator
