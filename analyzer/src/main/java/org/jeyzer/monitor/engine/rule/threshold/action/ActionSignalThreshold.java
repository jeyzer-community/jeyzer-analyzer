...
public class ActionSignalThreshold extends MonitorTaskThreshold{

	public static final String THRESHOLD_NAME = "action signal";	
	
	public ActionSignalThreshold(ConfigMonitorThreshold thCfg, SubLevel defaultSubLevel) {
		super(thCfg, Scope.ACTION, MatchType.SIGNAL, defaultSubLevel);
	}
