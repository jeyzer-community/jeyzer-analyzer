...
public class GlobalSignalThreshold extends MonitorSessionThreshold{

	public static final String THRESHOLD_NAME = "global signal";
	
	public GlobalSignalThreshold(ConfigMonitorThreshold thCfg, SubLevel defaultSubLevel) {
		super(thCfg, Scope.GLOBAL, MatchType.SIGNAL, defaultSubLevel);
	}
