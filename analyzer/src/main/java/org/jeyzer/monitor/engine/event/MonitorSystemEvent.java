...
public abstract class MonitorSystemEvent extends MonitorEvent {

	public MonitorSystemEvent(String eventName, MonitorEventInfo info) {
		super(eventName, info);
	}
	
	public abstract void updateContext(JzrSession session);
